...
<html lang="en">
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary navbar-light">
            ...
            <h1>TEHTUD TOOD</h1>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Dolorum quibusdam totam non dolorem. Doloribus at fuga neque excepturi rerum id accusamus officia voluptate, tempore autem, alias earum fugiat ex optio.</p>
        </div>
        <script
