        ...
        <nav class="navbar navbar-expand-lg bg-body-tertiary navbar-light">
            ...
            <form action="admin.php" method="post">
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="tekst" name="tekst" rows="3"></textarea>
                    <input type="submit" class="btn btn-primary mt-3"></button>
                </div>
            <?php
                $allikas = 'tekstid.txt';
                $tekst = fopen($allikas, 'w') or die('Ei saanud avada faili!');
                if (isset($_GET['tekst'])) {
                    $tekstget = $_GET['tekst'];
                    echo $tekstget;
                    fwrite($tekst, $tekstget);
                    fclose($tekst);
                }
            ?>
