...
// tempid 2
let madalaim = Infinity // suht loll et see tootab
let korgeim = -Infinity

for (let i = 0; i < temperatures.length; i++) {
    for (let j = 0; j < temperatures[i].length; j++) { // lenght -> length jata meelde
...
print("korgeim on " + korgeim + " / " + kuu2)
print("madalaim on " + madalaim + " / " + kuu)
